...
export const AA_PAIRS: readonly ContrastPair[] = [
    ...
    textPair('muted-foreground', 'muted', 'avatar fallback, tab list'),
    ...
    uiPair('border', 'muted', 'rule on a muted fill'),
    ...
    uiPair('primary-soft-border', 'primary-soft', 'link wash edge'),
