...
const en = {
    ...
    admin: {
        ...
        ekskulMinMembers: 'Minimum members',
        ekskulMinMembersHint:
            'Paying members needed per session to cover shared costs, e.g. venue rent (0 = no minimum)',
        ekskulRecurringTitle: 'Weekly session auto-schedule',
        ekskulRecurringHint:
            "This month's weekly sessions are created automatically on the chosen day (Monthly mode).",
        ekskulRecurringDay: 'Day of week',
        ekskulRecurringOff: 'Off (create sessions manually)',
    ...
    common: {
        ...
        phoneCountryCodeHint:
            'WhatsApp number — country code without + (e.g. 628...)',
    },
    days: [
        'Sunday',
        'Monday',
...
const id: typeof en = {
    ...
    common: {
        ...
        success: 'Berhasil',
        phoneCountryCodeHint:
            'Nomor WhatsApp — kode negara tanpa + (contoh: 628...)',
    },
    days: [
        'Minggu',
        'Senin',
