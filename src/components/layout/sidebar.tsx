    ...
    <aside className="flex flex-col h-full w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100 dark:border-gray-800">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">Manajemen Komunitas</p>
        </div>
      </div>
      ...
      <div className="border-t border-gray-100 dark:border-gray-800 p-4">
        ...
        <button
          ...
          className="flex items-center gap-2 text-sm text-red-500 hover:text-red-700 dark:hover:text-red-400 transition-colors px-1 py-1 w-full rounded hover:bg-red-50 dark:hover:bg-red-900/20"
        >
