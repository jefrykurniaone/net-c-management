...
const en = {
  ...
  auth: {
    ...
    errorMessage: 'An error occurred during the login process. Please try again.',
  ...
  admin: {
    ...
    confirmDelete: 'Are you sure you want to delete this session? All attendance data will also be deleted.',
...
const id: typeof en = {
  ...
  payments: {
    ...
    toastSuccess: 'Bukti pembayaran berhasil diupload! Menunggu konfirmasi admin.',
  ...
  validation: {
    ...
    fileTypeInvalid: 'Format file tidak didukung. Gunakan JPG, PNG, atau WebP.',
