...
| **The Register takes data, never nodes** — one component draws every admin table, five column kinds decide the treatment | Retired per ADR 0003: admin surfaces compose tables inside cards. The kind-decides-alignment discipline is worth carrying forward and is the admin spec's (#144) to place |
