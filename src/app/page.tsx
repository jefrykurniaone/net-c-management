...
//
// A rail, a band stack and a footer; two of the four bands render conditionally
// and the page stays short when they do not. Every string is generic by default
// and the Admin's when they have written one.
//
